<?php
    ...
    function lista_um_aluno($quartaparte){
        global $conexao;
        $stmt = $conexao->preparequery("SELECT * FROM alunos WHERE id = ?");
    ...
    function insere_curso(){
        global $conexao;
        //OPÇÃO 1 COM JSON
        // $input = json decocde(file_get_contents('php://input'), true);
    ...
    function atualiza_aluno(){
        ...
        //Aqui pode ser pensada em vários tipos de lógica, como por exemplo se somente um des tes campos vierem preenchidos. 
    ...
    function atualiza_aluno(){
        global $conexao;
        //Para atualizar um curso é obrigatório o envio do ID do curso
        //Precisa enviar todos os dados que serem atualizados (nome_curso, etc)
        //Aqui pode ser pensada em vários tipos de lógica, como por exemplo se somente um des tes campos vierem preenchidos. 
        //Neste exemplo vamos pensar que todos os campos serão enviados preenchidos, com ou sem alterações.
